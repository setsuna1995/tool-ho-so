...
def _has_partner_org_field(ws) -> bool:
...
def add_partner_org_field() -> None:
    ...
    for sheet_name in SHEET_NAMES:
        ...
        ws.cell(row=INSERT_AT_ROW, column=1, value="A06")
        ws.cell(row=INSERT_AT_ROW, column=2, value="Cơ quan phối hợp (Tùy chọn)")
        ws.cell(
            row=INSERT_AT_ROW,
            column=6,
...
if __name__ == "__main__":
    add_partner_org_field()
    print("Da them truong A06 'Co quan phoi hop' vao ca 2 sheet.")
